...
// additional woocommerce theme customization
// use this in place of the immediately preceding function, but not both
...
// updated for PHP 7.2+ create_function() is deprecated
add_filter( 'loop_shop_per_page', function($cols) {return $cols;}, 24 );
